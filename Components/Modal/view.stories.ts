import template from '@/Components/Modal/index.twig?url';
import type { Meta, StoryObj } from '@storybook/html';
import type { ModalModel } from './model';
import { renderTwig } from '../../stories/utils';

const meta: Meta<ModalModel> = {
...
const Template = (args: ModalModel) => {
  return compiled.render({ model: args });
};

export const Icon: StoryObj<ModalModel> = {
  render: Template,
  args: {
    icon: 'menu',
    title: 'Responsive',
...
export const Figure: StoryObj<ModalModel> = {
  render: Template,
  args: {
    title: '$N.NN',
