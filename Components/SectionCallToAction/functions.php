...
add_filter('Flynt/addComponentData?name=SectionCallToAction', function (array $data): array {
    $model = [
        ...
        'action' => [
            ...
            'hubspotForm' => $data['actionType'] == 'hubspot' && !empty($data['hubspotForm']) ? $data['hubspotForm'] : null,
            'reusable' => $data['actionType'] == 'reusable' && !empty($data['reusable']) ? $data['reusable'] : null,
        ],
