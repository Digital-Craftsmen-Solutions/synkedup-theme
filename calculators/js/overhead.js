var defaultExpenses = [
  { name: "Advertising & Marketing", heading: true },
  { name: 'Website', value: 0 },
  { name: 'Advertising', value: 0 },
  { name: 'Uniforms', value: 0 },
  { name: "Client Gifts", value: 0 },
  { name: "Bank & Financial Charges", heading: true },
  { name: "Bank fees", value: 0 },
  { name: "Credit Card Processing fees", value: 0 },
  { name: "Interest Expenses", value: 0 },
  { name: "Taxes & Licenses", value: 0 },
  { name: "Equipment & Truck", heading: true },
  { name: "Equip & Trucks Recovered in Overhead", value: 0 },
  { name: "Equipment Maintenance", value: 0 },
  { name: "Truck Maintenance", value: 0 },
  { name: 'Fuel', value: 0 },
  { name: 'Rentals', value: 0 },
  { name: "Donations & Charity", heading: true },
  { name: "Local sponsorships", value: 0 },
  { name: 'Donations', value: 0 },
  { name: 'Charity', value: 0 },
  { name: "Overhead Staff", heading: true },
  { name: "Owner's Salary", value: 0 },
  { name: "Sales Staff", value: 0 },
  { name: "Marketing Staff", value: 0 },
  { name: "Office Admin", value: 0 },
  { name: "Payroll Taxes and Labor Burden", value: 0 },
  { name: "Gifts/Bonuses", value: 0 },
  { name: "Professional Services", heading: true },
  { name: 'Consulting', value: 0 },
  { name: 'Accountant', value: 0 },
  { name: 'Insurance', value: 0 },
  { name: "Professional Fees", value: 0 },
  { name: "Small Equipment", heading: true },
  { name: "Job Trailer Tools", value: 0 },
  { name: "Small Engine equipment", value: 0 },
  { name: "Subscriptions & Dues", heading: true },
  { name: 'Subscriptions', value: 0 },
  { name: "Postage & Delivery", value: 0 },
  { name: 'Travel', heading: true },
  { name: "Meetings/Training", value: 0 },
  { name: "Tradeshows/Events", value: 0 },
  { name: 'Utilities', heading: true },
  { name: 'Internet', value: 0 },
  { name: "Cell Phones", value: 0 },
  { name: 'Water', value: 0 },
  { name: 'Electricity', value: 0 },
  { name: 'Misc', heading: true },
  { name: "Garbage Disposal", value: 0 },
  { name: "Office Supplies", value: 0 },
  { name: "Shop Rent", value: 0 },
  { name: 'Other', value: 0 },
];
...
var calculateOutput = function () {
  ...
  budget.overheadCosts = overheadSum
...
var setupButtonEvents = function () {
  jQuery(".clear-values").click(function () {
    localStorage.setItem("saved_overhead1", JSON.stringify(defaultExpenses));
    location.reload();
  });
...
saveData = function () {
  ...
  localStorage.setItem("saved_overhead1", JSON.stringify(expenses));
  }
};
...
$(document).ready(function () {
  ...
  if (/[?&]onboarding=true/.test(location.search)) {
    ...
    $("#gform_submit_button_52").val('Next');
  } else if (/[?&]return=budget/.test(location.search)) {
    console.log('return budget')
    $(".email-field-block .gfield_label").hide();
    $("#gform_submit_button_52").val('Finish and return to Budgeting Calculator');
  }
